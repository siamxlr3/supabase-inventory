  ...
  return (
    <>
      <PageHeader
        ...
        description="Create a new customer profile in your database"
        breadcrumbs={[
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-8">
            ...
            <div className="p-6 bg-indigo-50/50 rounded-2xl border border-indigo-100/50">
              <h4 className="text-[11px] font-bold text-indigo-900 uppercase tracking-widest mb-2">Pro Tip</h4>
              <p className="text-xs text-indigo-700 leading-relaxed">
                Adding a phone number and city helps in calculating shipping rates more accurately during checkout.
              </p>
            </div>
          </div>
        </div>
