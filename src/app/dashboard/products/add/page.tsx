            ...
            <div className="xl:col-span-2 space-y-6">
              <Card>
                ...
                <div className="space-y-4">
                  ...
                  <Textarea label="Description" id="description" placeholder="Write a detailed product description..." value={formData.description} onChange={handleChange} />
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <Input label="Handle / Slug" id="handle" placeholder="e.g. wireless-mouse-pro" value={formData.handle} onChange={handleChange} />
                    <Input label="Vendor" id="vendor" placeholder="e.g. Logitech" value={formData.vendor} onChange={handleChange} />
                  </div>
                </div>
              </Card>
            </div>
            <div className="space-y-6">
              <Card>
                ...
                <div className="space-y-4">
                  ...
                  <Input label="Product Type" id="product_type" placeholder="e.g. Electronics" value={formData.product_type} onChange={handleChange} />
                </div>
              </Card>
